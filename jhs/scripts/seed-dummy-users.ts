...
const PERSONAS: Persona[] = [
  ...
  { id: "dummy_02", name: "박지우", email: "jiwoo@demo.local", cats: ["요리·먹방", "People & Blogs", "Travel & Events"] },
  { id: "dummy_03", name: "이서연", email: "seoyeon@demo.local", cats: ["News & Politics", "Education", "Science & Technology"] },
  { id: "dummy_04", name: "최하은", email: "haeun@demo.local", cats: ["뷰티·패션", "People & Blogs", "Entertainment"] },
  { id: "dummy_05", name: "정도윤", email: "doyoon@demo.local", cats: ["Travel & Events", "People & Blogs", "요리·먹방"] },
  ...
  { id: "dummy_08", name: "윤수아", email: "sua@demo.local", cats: ["Pets & Animals", "People & Blogs", "생활·하우투"] },
  { id: "dummy_09", name: "임예준", email: "yejun@demo.local", cats: ["영화", "애니메이션", "Comedy"] },
